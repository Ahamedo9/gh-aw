...
hero:
  ...
  tagline: <strong>Intelligent automation for GitHub — running the coding agents you know and love, with strong guardrails and cost controls, in GitHub Actions</strong>
  actions:
